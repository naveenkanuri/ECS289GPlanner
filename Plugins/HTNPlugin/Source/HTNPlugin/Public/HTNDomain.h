...
DECLARE_LOG_CATEGORY_EXTERN(HTNPlugin, Log, All);
...
UCLASS()
class HTNPLUGIN_API UWorldStateComponent : public UBlackboardComponent
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct HTNPLUGIN_API FSHTNPrimitiveTask
{
	GENERATED_BODY()
...
//	CHANGE
	...
	//UPROPERTY(EditAnywhere, BlueprintReadWrite)
	//TSubclassOf<UHTNOperator> Action;

	//UHTNOperator* ActionPtr;
...
USTRUCT(BlueprintType)
struct HTNPLUGIN_API FSHTNMethod
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct HTNPLUGIN_API FSHTNCompositeTask
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct HTNPLUGIN_API FSHTNDomain
{
	GENERATED_BODY()
...
struct HTNPLUGIN_API FSHTNWorldState
{
	FSHTNWorldState();
	~FSHTNWorldState();
