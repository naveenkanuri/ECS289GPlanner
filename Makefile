...
UNREALROOTPATH = /media/naveen/data/UnrealEngine
GAMEPROJECTFILE =/media/naveen/data/HTNPlanner/HTNPlanner.uproject

TARGETS = \
	HTNPlanner-Linux-Debug  \
	HTNPlanner-Linux-DebugGame  \
	HTNPlanner-Linux-Test  \
	HTNPlanner-Linux-Shipping  \
	HTNPlanner \
	HTNPlannerEditor-Linux-Debug  \
	HTNPlannerEditor-Linux-DebugGame  \
	HTNPlannerEditor-Linux-Test  \
	HTNPlannerEditor-Linux-Shipping  \
	HTNPlannerEditor \
...
HTNPlanner-Linux-Debug:
	 $(PROJECTBUILD) HTNPlanner Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

HTNPlanner-Linux-DebugGame:
	 $(PROJECTBUILD) HTNPlanner Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

HTNPlanner-Linux-Test:
	 $(PROJECTBUILD) HTNPlanner Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

HTNPlanner-Linux-Shipping:
	 $(PROJECTBUILD) HTNPlanner Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

HTNPlanner:
	 $(PROJECTBUILD) HTNPlanner Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

HTNPlannerEditor-Linux-Debug:
	 $(PROJECTBUILD) HTNPlannerEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

HTNPlannerEditor-Linux-DebugGame:
	 $(PROJECTBUILD) HTNPlannerEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

HTNPlannerEditor-Linux-Test:
	 $(PROJECTBUILD) HTNPlannerEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

HTNPlannerEditor-Linux-Shipping:
	 $(PROJECTBUILD) HTNPlannerEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

HTNPlannerEditor:
	 $(PROJECTBUILD) HTNPlannerEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
